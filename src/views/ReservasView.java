        ...
        txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                if (txtFechaSalida.getDate() != null && txtFechaEntrada.getDate() != null) {
                    System.out.println("seleccionaron fecha");
                    //obtener valores seleccionados
                    LocalDate fechaDeEntrada = CalcularReserva.convertToLocalDateViaInstant(txtFechaEntrada.getDate());
                    LocalDate fechaDeSalida = CalcularReserva.convertToLocalDateViaInstant(txtFechaSalida.getDate());

                    //funcion calcular total a pagar
                    double cantidadPorPagar = CalcularReserva.calcularReserva(fechaDeEntrada, fechaDeSalida);
                    System.out.println("total por pagar: " + cantidadPorPagar);
                    String cantidadPorPagarString = String.valueOf(cantidadPorPagar);

                    txtValor.setText(cantidadPorPagarString);
                }
        ...
        btnsiguiente.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
                    ...
                    //convertir fechas de string a localdate para insertar en la db
                    LocalDate fechaEntradaInsertar = CalcularReserva.convertToLocalDateViaInstant(txtFechaEntrada.getDate());
                    LocalDate fechaSalidaInsertar = CalcularReserva.convertToLocalDateViaInstant(txtFechaSalida.getDate());
                    String strPagar = txtValor.getText();
                    double dPagarInsertar = Double.parseDouble(strPagar); // returns double primitive
                    //crear objeto de reserva 
                    Reserva reserva = new Reserva(
                            fechaEntradaInsertar,
                            fechaSalidaInsertar,
                            dPagarInsertar,
                    ...
                    //insertar
                    try {
                        ReservaDao reservaDao = new ReservaDao(con.recuperaConexion());
                        int idReserva = reservaDao.guardar(reserva);

                        if (idReserva > 0) {
                            JOptionPane.showMessageDialog(null, "Se guardo la reserva con exito");
