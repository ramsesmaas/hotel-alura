...
public class RegistroHuesped extends JFrame {
    ...
    public RegistroHuesped(int idReserva) {
        ...
        System.out.println("recibi id:" + idReserva);
        ...
        txtNreserva.setEditable(false);//que no se pueda editar eso
        ...
        btnguardar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                //evento orpimiereon el boton de guardar
                System.out.println("SE OPRIMIO EL BOTN DE GUARDAR HUESPED");
               int numeroTelefono = 0;
                ////validar que los campos no esten vacios y lanzar alertas
                if (txtFechaN.getDate() != null && txtNombre.getText() != "" && txtApellido.getText() != "" ) {
                    LocalDate fechaNacimiento = CalcularReserva.convertToLocalDateViaInstant(txtFechaN.getDate());
                    //obteniendo numero de telefono
                    try {
                        String numeroStr = txtTelefono.getText();
                         numeroTelefono = Integer.parseInt(numeroStr);
                         
                    } catch (NumberFormatException ne) {
                        JOptionPane.showMessageDialog(null, "Debe ingresar numeros en el campo de numero de telefono ");
                        return;
                    }
                ...
                try {
                    HuespedDao huespedDAO = new HuespedDao(con.recuperaConexion());
                    int respuesta = huespedDAO.guardar(huesped);
                    if (respuesta > 0) {//no funciona?
                        JOptionPane.showMessageDialog(null, "Se guardo el huesped: " + huesped.getNombre());
                    }
                    dispose();
