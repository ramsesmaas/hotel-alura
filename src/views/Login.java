...
public class Login extends JFrame {
	...
	private void Login() {
	     ...
	     String contrasena=new String (txtContrasena.getPassword());
            ...
            try {
                UsuarioDao hd = new UsuarioDao(con.recuperaConexion());
                usuario = hd.obtenerUsuarioPorNombre(nombre, contrasena);
	        ...
	        String contrase=new String (usuario.getContrasena());

	        if(txtUsuario.getText().equals(usuario.getNombre()) && contrase.equals(contrase)){
